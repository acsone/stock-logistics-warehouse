...
class StockQuant(models.Model):
    ...
    def _check_location_product_restriction(self):
            ...
            if len(product_ids) > 1:
                ...
                error_msgs.append(
                    _(
                        ...
                        "product. You plan to put different products to "
        ...
        """
        self.env.cr.execute(
            SQL, (tuple(quants_to_check.mapped("location_id").ids),)
        )
        ...
        for (
            ...
            if set(existing_product_ids).symmetric_difference(product_ids_to_add):
                ...
                error_msgs.append(
                    _(
                        "You plan to add the product {product} to the location {location} "
